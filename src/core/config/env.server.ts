...
export const envServer = {
  ...
  docusignAuthBaseUrl: optionalEnv('DOCUSIGN_AUTH_BASE_URL'),
  docusignApiBaseUrl: optionalEnv('DOCUSIGN_API_BASE_URL'),
  docusignAccountId: optionalEnv('DOCUSIGN_ACCOUNT_ID'),
